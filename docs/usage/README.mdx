...
- Standalone kits: educational kits using openUC2's approachable modular optics system.
  ...
  - [QBox](./disc/qbox/README.md) {/* build:exclude=minimal */}
  - [QBox](https://openuc2.github.io/usage/disc/qbox/) {/* build:exclude=full */}
  - [HoloBox](./disc/holobox/README.md)
  - [XIAO Microscope](./disc/xiao-microscope/README.md) {/* build:exclude=minimal */}
  - [XIAO Microscope](https://openuc2.github.io/usage/disc/xiao-microscope/) {/* build:exclude=full */}
