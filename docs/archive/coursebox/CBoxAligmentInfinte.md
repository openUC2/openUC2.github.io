...
This is the alignment procedure of the experiments with infinity-corrected optics. If you are looking for the finite-corrected setups [click here](./CBoxAligmentFinite.md), but this page is more complex and up-to-date.  
...
* In this demonstration of the experiment, two Alvium cameras from Allied vision are used, so we can show the PIP and BFP on the screen simultaneously
  * Find the cubes for the Alvium cameras [here](https://github.com/openUC2/UC2-GIT/tree/master/CAD/ASSEMBLY_CUBE_AlliedVision_Alvium) anch choose the adjustable insert for easy alignment.
