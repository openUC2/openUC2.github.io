...
For additional information and an in-depth explanation for the UC2e system, please have a look [here](https://docs.openuc2.com/docs/Electronics/Advanced/UC2-ESP/Setup_Buildenvironment)
