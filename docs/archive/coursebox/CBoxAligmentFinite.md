...
This is the alignment procedure of the experiments with finite-corrected optics. If you are looking for the infinity-corrected setups [click here](./CBoxAligmentInfinte.md).
