...
Taking a series of DPC images at different focal planes. Left: Cropped DPC image of Unknown cells (left) and Cheek cells (right) captured with 0.25 NA microscope objective with 10x magnification.
