...
- [coreBOX](https://docs.openuc2.com/docs/Toolboxes/CoreBox/ENGLISH/uc2miniboxEN)
-  [openUC2 x Seeed Studio AI Microscope](https://docs.openuc2.com/docs/Toolboxes/SeeedMicroscope/04_1_seeedmicroscope)
- [openUC2 ElectronicsBox](https://docs.openuc2.com/docs/Toolboxes/ElectronicsBox/automation_intro)
...
2. Assemble a **[simple telescope](https://docs.openuc2.com/docs/Toolboxes/CoreBox/ENGLISH/CoreTelescope)** to understand lens focusing.
...
3. Build the **[smartphone microscope](https://docs.openuc2.com/docs/Toolboxes/CoreBox/ENGLISH/coreMicroscope#smartphone-microscope)** using the RMS objective holder and phone adapter.
...
<video controls width="90%">
  <source src={require("./IMAGES/IMG_7708.MOV").default} />
</video>
...
More information [here](https://docs.openuc2.com/docs/Toolboxes/SeeedMicroscope/04_3_seeedmicroscoperepair)
...
*Further reading:*
- Theory and Implementation of DPC: https://docs.openuc2.com/docs/Toolboxes/InfinityBox/DPCmicroscopy
...
https://docs.openuc2.com/docs/Toolboxes/LightsheetBox/Light_sheet_Fluoresence_microscope or https://openuc2.com/light-sheet-3
