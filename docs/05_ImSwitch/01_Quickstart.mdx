...
1. Wait until the Raspberry Pi boots and you see the SSID `openUC2-XXX-1234` (XXX-1234 are based on the raspis' MAC).
2. Connect to the SSID and navigate to http://192.168.4.1/admin/cockpit/ or http://192.168.4.1:9090/admin/cockpit/ to access Cockpit.
