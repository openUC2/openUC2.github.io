...
[14:20, 2/24/2026] Ethan Li: It will work if we use html tags; I guess markdown's image syntax doesn't work for SVG. If you currently have a usage/disc/qbox/README.mdx file with:

<img src={require("./quantummap.drawio.svg").default} />

then I would suggest renaming the file to usage/disc/qbox/README.mdx and changing that markdown snippet to:
