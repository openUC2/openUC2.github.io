...
[14:20, 2/24/2026] Ethan Li: It will work if we use html tags; I guess markdown's image syntax doesn't work for SVG. If you currently have a usage/disc/qbox/README.md file with:
